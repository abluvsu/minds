...
function AppCore() {
  ...
  // Sourced from the provider registry (cowork-server /api/v1/providers),
  // flattened to one picker option per (provider, model) pair. Empty
  // until the registry has at least one enabled entry with models —
      ...
      <main style={{
        ...
        {route === 'task' && currentTask && (
          <ChatView
            ...
            models={modelOptions}
            onModelChange={handleChangeTaskModel}
            attachments={composerAttachments}
            connectors={connectors}
            onAttachFiles={handleAttachFiles}
            disabledConnections={composerDisabledConnections}
        ...
        {route === 'settings' && (
          <SettingsView settings={settings} setSetting={setSetting} onSave={saveSettings} theme={theme} onThemeChange={setTheme} skin={skin} onSkinChange={setSkin} customTheme={customTheme} onCustomThemeChange={setCustomTheme} agentLabel={agentLabel} onModelSourcesChanged={refreshModels} />
        )}
